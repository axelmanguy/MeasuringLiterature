...
for node in G.nodes():
  ...
  for node2 in G.nodes():
    n+=G.number_of_edges(node,node2)
  values2.append(100*(n/len(G.edges())))
print(values2)
...
plt.scatter(values,values2, label='macbeth_play', color='darkgreen')
...
values=np.array(values)
values2=np.array(values2)
plt.scatter(values,values2, label='macbeth_opera',color='yellowgreen')
...
values=np.array(values)
values2=np.array(values2)
plt.scatter(values,values2, label='figaro_opera',color='deepskyblue')
...
values=np.array(values)
values2=np.array(values2)
plt.scatter(values,values2, label='figaro_play',color='royalblue')
...
values=np.array(values)
values2=np.array(values2)
plt.scatter(values,values2, label='Rigoletto',color='salmon')
...
values=np.array(values)
values2=np.array(values2)
plt.scatter(values,values2, label="Le roi s'amuse",color='crimson')

plt.legend()
plt.ylabel("% of speech")
plt.xlabel("% of edges")
plt.show()